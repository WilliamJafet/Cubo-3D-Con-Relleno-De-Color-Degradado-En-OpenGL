 ...
 */
public class GTemaThreeDegradado implements GLEventListener {
    static GL gl;
    static GLU glu;
    ...
    public static void main(String[] args) {
        Frame frame = new Frame("Cubo 3D degradado");
        GLCanvas canvas = new GLCanvas();

        canvas.addGLEventListener(new GTemaThreeDegradado());
        frame.add(canvas);
    ...
    public void reshape(GLAutoDrawable drawable, int x, int y, int width, int height) {
        ...
        gl.glMatrixMode(GL.GL_PROJECTION);
        gl.glLoadIdentity();
        glu.gluPerspective(55.0f, h, 1.0, 60.0);
